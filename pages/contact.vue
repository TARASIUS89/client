<template>
    ...
    <ul class="my-4 text-black dark:text-white">
        <li>Номер: <a class="underline hover:text-blue-500" href="tel:79933079829">+7 9282947307</a></li>
        <li>Почта: <a class="underline hover:text-blue-500" href="mailto:oleg@nastyle.pro">pulse_sport@mail.ru</a></li>
    </ul>
